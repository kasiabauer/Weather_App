...
// backup gdyby async/await mi nie działał
// const getIP = fetch('https://api64.ipify.org').then( resp => resp.text()).then( ip => console.log(ip));
// console.log(getIP);
//
// const doSth = ip => {
//     return (ip)
...
//     //tu robimy
// }
// // let ip = getIpAsync().then(e => console.log(e))
//
// console.log(doSth());
